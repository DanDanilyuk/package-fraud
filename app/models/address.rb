class Address < ApplicationRecord
  ...
  def standardize_address
    ...
    self.city.gsub!('NORTH','N')
    self.city.gsub!('SOUTH','S')
    self.city.gsub!('WEST','W')
    self.city.gsub!('EAST','E')
    self.city.gsub!('NORTHWEST','NW')
    self.city.gsub!('NORTHEAST','NE')
    self.city.gsub!('SOUTHEAST','SE')
    self.city.gsub!('SOUTHWEST','SW')
